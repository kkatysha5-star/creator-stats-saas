...
const CREATOR_SLIDES = [
  ...
  },
  {
    ...
    text: 'На дашборде вы видите статистику всей команды — просмотры, лайки, ER по каждому креатору. Нажмите на имя — откроется детальная страница с аналитикой и всеми роликами.',
    tip: 'Статистика обновляется автоматически каждые 6 часов. Можно обновить вручную кнопкой «↻ Обновить данные».',
  },
  {
    icon: '🛒',
    title: 'Воронка продаж',
    text: 'В разделе «Воронка» видны конверсии всей команды — заходы по артикулу, корзина, заказы. Данные вносит владелец раз в неделю.',
    tip: 'Вы видите динамику по периодам и можете сравнивать результаты между собой.',
  },
];
